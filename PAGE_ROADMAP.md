...
| `/tier-list/weapons` | PUBLISHED | 独立承接 weapon tier list、S–C ranking 和排序标准；使用 wave control、boss pressure、scaling、safety、investment value 框架，避免复制 Best Weapons by Role 正文 | 2026-08-24，官方 Google Play 页面确认 App 名称、开发者和 Android/Windows 平台边界；S–C 排名是编辑框架，不是官方 VOODOO 排名 |
